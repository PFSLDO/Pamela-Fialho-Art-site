$(document).ready(function() {
    ...
    $('.js--scroll-to-artist').click(function() {
        $('html, body').animate({scrollTop: $('.js--section-artist').offset().top}, 1000);
    });
    ...
    $('.js--wp-3').waypoint(function(direction) {
       $('.js--wp-3').addClass('animated animate__fadeInRight'); 
    }, {
        offset: '50%'
    });
    ...
    $('.js--nav-icon').click(function() {
        var nav = $('.js--main-nav');
        var icon = $('.js--nav-icon .mobile-nav-icon ion-icon');
        nav.slideToggle(200);
    });
});